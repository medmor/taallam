...
export default function HtmlCommentsBox() {
    ...
    return (
        <div className="shadow-lg bg-white p-4 mt-5 sm:min-w-[500px]">
            ...
            <Script id="htmlcommentsbox" strategy="lazyOnload">
                {`
                    if (!window.hcb_user) {
                    ...
                    (function(){
                        ...
                        s.setAttribute("src", h+"/jread?page="+encodeURIComponent(l).replace("+","%2B")+"&mod=%241%24wq1rdBcg%24ULEEOXDwJOmf1X6137mqN."+"&opts=16798&num=10&ts=1687870882651");
