const sounds = {
  ...
  // Enhanced sound effects for better game experience
  success: '/sounds/effects/correct.mp3',
  achievement: '/sounds/effects/win.mp3',
  levelup: '/sounds/effects/win.mp3',
  countdown: '/sounds/effects/click.mp3',
  streak: '/sounds/effects/correct.mp3',
  bonus: '/sounds/effects/win.mp3',
  start: '/sounds/effects/click.mp3',
  explosion: '/sounds/effects/explosion.mp3',
  lose: '/sounds/effects/lose.mp3'
};
