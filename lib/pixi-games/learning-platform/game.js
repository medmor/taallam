import { preloadSfx, playSfx, startMusicLoop, stopMusicLoop, pauseMusic, resumeMusic, setMusicMuted, setMuted, unlockSfxOnGesture } from '@/lib/sfx';
...
export default class Game {
    ...
    this.app.stage.addChild(this.debugHud);
        ...
        try {
            if (this.ui) {
                this.ui.onMuteToggle = (isMuted) => { try { if (typeof setMusicMuted === 'function') setMusicMuted(isMuted); setMuted && setMuted(isMuted); } catch (e) { } };
                this.ui.onPauseToggle = (isPaused) => { try { this.pause(); } catch (e) { } };
            }
        } catch (e) { }
