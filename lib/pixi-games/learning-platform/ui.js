...
export default class UIManager {
    ...
    this.container.x = 0; this.container.y = 0;
        ...
        this.healthText = new PIXI.Text({ text: '', style: { fontFamily: 'monospace', fontSize: 12, fill: 0xffffff } });
        this.healthText.x = this._barX + 6; this.healthText.y = this._barY - 2;
    ...
    try { this.messageText.anchor.set(0.5, 0.5); } catch (e) { }
        ...
        this.container.addChild(this.healthBg, this.healthFg, this.healthText, this.timerText, this.messageText);
    ...
    setHealth(current, max) {
        ...
        try { this.healthText.text = `HP: ${c}/${max}`; } catch (e) { }
    }
    ...
    destroy() {
        ...
        try { this.container.removeChild(this.healthBg); this.container.removeChild(this.healthFg); this.container.removeChild(this.healthText); this.container.removeChild(this.timerText); this.container.removeChild(this.messageText); } catch (e) { }
        ...
        try { this.healthText.destroy && this.healthText.destroy({ children: true }); } catch (e) { }
