...
export default class UIManager {
    ...
    this.container.addChild(this.healthBg, this.healthFg, this.timerText, this.messageText);
        ...
        const mbg = new PIXI.Graphics(); mbg.beginFill(0x000000, 0.4); mbg.drawRect(0,0,this.btnSize,this.btnSize); mbg.endFill();
        this.muteIcon = new PIXI.Text('🔊', { fontFamily: 'monospace', fontSize: 16 }); this.muteIcon.x = 6; this.muteIcon.y = 4;
        ...
        const pbg = new PIXI.Graphics(); pbg.beginFill(0x000000, 0.4); pbg.drawRect(0,0,this.btnSize,this.btnSize); pbg.endFill();
        this.pauseIcon = new PIXI.Text('⏸', { fontFamily: 'monospace', fontSize: 16 }); this.pauseIcon.x = 6; this.pauseIcon.y = 4;
